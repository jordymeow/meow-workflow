...
if ( !class_exists( 'MeowKit_MWFLOW_Helpers' ) ) {

  class MeowKit_MWFLOW_Helpers {
    //public static $version = MeowKit_MWFLOW_Admin::version;
    ...
    public static function timer_start( $timerName = 'default' ) {
      MeowKit_MWFLOW_Helpers::$startQueries[ $timerName ] = get_num_queries();
      MeowKit_MWFLOW_Helpers::$startTimes[ $timerName ] = microtime( true );
    }

    public static function timer_elapsed( $timerName = 'default' ) {
      return microtime( true ) - MeowKit_MWFLOW_Helpers::$startTimes[ $timerName ];
    }

    public static function timer_log_elapsed( $timerName = 'default' ) {
      $elapsed = MeowKit_MWFLOW_Helpers::timer_elapsed( $timerName );
      $queries = get_num_queries() - MeowKit_MWFLOW_Helpers::$startQueries[ $timerName ];
  ...
  // if ( MeowKit_MWFLOW_Helpers::is_rest() ) {
